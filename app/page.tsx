          ...
          <div className='lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-around lg:py-24'>
            <div>
              ...
              <h2 className='mt-3 text-lg font-medium tracking-tight text-primary sm:text-xl'>
                Software Engineer at PRiADI
              </h2>
              <p className='mt-4 max-w-xs leading-normal'>
                I always try build something that meant to be useful, with good performance and stability.
              </p>
            </div>
          ...
          <div className='pt-24 lg:w-1/2 lg:py-20 lg:min-h-screen lg:flex lg:flex-col lg:justify-center'>
            ...
            {!isLoadingSection ? (
              <div>
                <div id='about' className={`${activeSection != 'about' ? 'lg:hidden' : ''}`} aria-label='About me'>
                  ...
                  <div>
                    <p className='mb-4 text-justify'>
                      ...
                      world of coding. My first encounter with code occurred when I wanted to modify a game with a
                      custom asset and change its saved data. From that on, my passion for programming has grown more
                      and more. Jump to the present time, and I&apos;ve trusted to build software for a&nbsp;
                    ...
                    <p className='mb-4 text-justify'>
                      My current focus these days is building software and maintaining it. I enjoy working on
                      challenging projects that push me to learn and collaborate. My work philosophy revolves around
                      continuous improvement, teamwork, and solving problems. In my free time, I usually RnD-ing my
                      current work.
                    </p>
                  </div>
                </div>
                      ...
                      <li className='mb-10 lg:mb-0'>
                        <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                          ...
                          <div className='z-10 col-span-6'>
                            ...
                            <p className='mt-2 text-sm leading-normal text-justify'>
                              While finishing high school, I&apos;ve taking several projects including library
                ...
                <div
                  id='projects'
                  className={`${activeSection != 'projects' ? 'lg:hidden' : ''}`}
                  aria-label='Projects'>
                  <div className='sticky top-0 z-20 -mx-6 mb-4 w-screen px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0'>
