  ...
  return (
    <div className=''>
      <div className='mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-20 lg:px-24 lg:py-0'>
        <div className=''>
          <div className='lg:flex lg:flex-col lg:pt-24'>
            <div>
              ...
              <p className='mt-4 leading-normal'>Think, Tinker, Explore. The world is our laboratory.</p>
            </div>
          ...
          <div className='lg:py-4 py-8 lg:flex lg:flex-col lg:justify-center'>
            <div className='gap-4 mb-8 hidden lg:flex'></div>
            <div>
              <div id='about' aria-label='About me'>
                <div className='sticky top-0 z-20 -mx-6 w-screen px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:mb-0 lg:mx-auto lg:w-full lg:px-0'>
                  <h2 className='text-base font-bold uppercase tracking-widest'>About</h2>
                </div>
                <div>
                  <p className='mb-4 text-justify'>
                    The curiosity about how things work and how to build it led me to pursue and dive into the vast world of coding. My
                    first encounter with code occurred when I wanted to modify a game with a custom asset and change its saved data. From
                    that on, my passion for programming has grown more and more. Jump to the present time, and I&apos;ve trusted to build
                    software for a&nbsp;
                    <a className='font-bold text-primary transition duration-300' href='https://priadi.id'>
                      psychology company
                    </a>
                    .
                    <br />
                  ...
                  <p className='mb-4 text-justify'>
                    My current focus these days is building software and maintaining it. I enjoy working on challenging projects that push
                    me to learn and collaborate. My work philosophy revolves around continuous improvement, teamwork, and solving problems.
                    In my free time, I usually RnD-ing my current work, write &quot;poetic&quot; words, and tinkering random stuffs.
                  </p>
                </div>
              </div>
              <div id='experience' aria-label='Work Experience'>
                <div className='sticky top-0 z-20 -mx-6 w-screen px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:mb-0 lg:mx-auto lg:w-full lg:px-0'>
                  <h2 className='text-base font-bold uppercase tracking-widest'>Experience</h2>
                </div>
                <div>
                  <ol className='group/list gap-8 lg:gap-6 flex flex-col'>
                    <li className=''>
                      <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                        ...
                        <div className='z-10 col-span-6'>
                          ...
                          <p className='mt-2 text-sm leading-normal text-justify'>
                            Developed and maintained websites, mobile apps, and desktop applications including CRM, HRIS, Admin Dashboard,
                            and more. Providing tech solution for the company through brainstorming, collaboration, and knowledge shares.
                          </p>
                    ...
                    <li className=''>
                      <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                        ...
                        <div className='z-10 col-span-6'>
                          ...
                          <p className='mt-2 text-sm leading-normal text-justify'>
                            While finishing high school, I&apos;ve taking several projects including library guestbook, cashier application
                            for school cooperatives, and more.
                          </p>
                          <ul className='mt-2 flex flex-wrap'>
                            <TechBadge name={'Java'} />
              ...
              <div id='projects' aria-label='Projects'>
                <div className='sticky top-0 z-20 -mx-6 w-screen px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:mb-6 lg:mx-auto lg:w-full lg:px-0'>
                  <h2 className='text-base font-bold uppercase tracking-widest'>Projects</h2>
                </div>
                <div>
                    ...
                    <li className='mb-12'>
                      <div className='group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                        ...
                        <div className='z-10 sm:order-2 sm:col-span-6'>
                          ...
                          <p className='mt-2 text-sm leading-normal'>When boredom meets code.</p>
                  ...
                  <Link className='inline-flex items-center font-semibold group mb-24' aria-label='View more projects' href='/projects'>
                    <span>
